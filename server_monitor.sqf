...
_soldermodelg18g = _modelarrayg18g select (round(random ((count _modelarrayg18g) - 1)));
if(_x == 2) then {
_soldermodelg18g createunit [[22590.16,20290.76,0.001], _AISgroupg18g, "_spawnAISg18g = this;"];
_spawnAISg18g setPosASL [22590.16,20290.76,0.001];
_spawnAISg18g setDir 255;
};
if(_x == 3) then {
_soldermodelg18g createunit [[22595.16,20295.76,0.001], _AISgroupg18g, "_spawnAISg18g = this;"];
_spawnAISg18g setPosASL [22595.16,20295.76,0.001];
_spawnAISg18g setDir 265;
};
if(_x == 4) then {
_soldermodelg18g createunit [[22350.16,20110.76,0.001], _AISgroupg18g, "_spawnAISg18g = this;"];
_spawnAISg18g setPosASL [22350.16,20110.76,0.001];
_spawnAISg18g setDir 273;
};
if(_x == 5) then {
_soldermodelg18g createunit [[22340.16,20110.76,0.001], _AISgroupg18g, "_spawnAISg18g = this;"];
_spawnAISg18g setPosASL [22340.16,20110.76,0.001];
_spawnAISg18g setDir 22;
};
if(_x == 6) then {
_soldermodelg18g createunit [[22430.16,20155.76,0.001], _AISgroupg18g, "_spawnAISg18g = this;"];
_spawnAISg18g setPosASL [22430.16,20155.76,0.001];
_spawnAISg18g setDir 338;
};
if(_x == 7) then {  
_soldermodelg18g createunit [[22500.16,20050.76,0.001], _AISgroupg18g, "_spawnAISg18g = this;"];
_spawnAISg18g setPosASL [22500.16,20050.76,0.001];
_spawnAISg18g setDir 283;
};
if(_x == 8) then {
_soldermodelg18g createunit [[22480.16,20100.76,0.001], _AISgroupg18g, "_spawnAISg18g = this;"];
_spawnAISg18g setPosASL [22480.16,20100.76,0.001];
